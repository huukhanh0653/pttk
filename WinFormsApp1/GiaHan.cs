...
namespace WinFormsApp1
{
    public partial class GiaHan : UserControl
    {
        ...
        private void LoadDSThiSinh()
        {
            ...
            //DataTable customerTable = ExecuteCommand(query, CommandType.Text);

            //if (customerTable.Rows.Count > 0)
            //{
            //    dgvDSThiSinh.DataSource = customerTable;
            //}
            //else
            //{
            //    MessageBox.Show("Không có dữ liệu trong bảng THI_SINH.", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            //}
        }
